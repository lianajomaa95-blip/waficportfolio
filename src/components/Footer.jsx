  ...
  return (
    <footer className="border-t border-navy-800 mt-24">
      <div className="max-w-6xl mx-auto px-6 py-12 sm:py-14">
        <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-8 sm:gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-center sm:text-left">
              <div className="font-display font-semibold leading-none">Wafic Abouhosh</div>
        ...
        {/* Copyright */}
        <p className="mt-10 text-center font-mono text-xs text-slate tracking-wide">
